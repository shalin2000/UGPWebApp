            ...
            <div>
                ...
                <body className="is-preload">
                        ...
                        <header className="major container medium">
                                ...
                                <Link to={{pathname: "/displayGrades", state: { linkState: this.state.courseSelected }}}> 
                                    <button disabled={this.state.btnDisable} class="button" 
                                    onClick={()=> localStorage.setItem('profInfo', JSON.stringify(this.state.courseSelected))} 
                                    onContextMenu = {()=> localStorage.setItem('profInfo', JSON.stringify(this.state.courseSelected))}
                                >
                                    Quick Search</button>
                                </Link>    
                                </header>
