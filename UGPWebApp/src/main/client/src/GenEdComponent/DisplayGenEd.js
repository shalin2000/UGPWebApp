        ...
        return(
            <div className='App'>
                ...
                <div className="box alt container">
                    ...
                    <section className="feature left" onClick={() => localStorage.setItem('row', JSON.stringify('ANW'))}>
                    ...
                    <section className="feature right" onClick={() => localStorage.setItem('row', JSON.stringify('UIS'))}>
                    ...
                    <section className="feature left" onClick={() => localStorage.setItem('row', JSON.stringify('UP'))}>
                    ...
                    <section className="feature right" onClick={() => localStorage.setItem('row', JSON.stringify('UCA'))}>
                    ...
                    <section className="feature left" onClick={() => localStorage.setItem('row', JSON.stringify('EWC'))}>
                    ...
                    <section className="feature right" onClick={() => localStorage.setItem('row', JSON.stringify('UUS'))}>
