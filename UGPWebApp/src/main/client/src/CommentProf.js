                    ...
                    <div className="row" style={{marginTop: '-50px'}}>
                        ...
                        <Col sm>
                            ...
                            <ul class="actions special">
                                <Link to={{pathname: "/displayCRSbyProf", state: { linkState: this.props.chosenCourseAndProf }}} onClick={()=> localStorage.setItem('listAllCRSByProf', JSON.stringify(this.props.chosenCourseAndProf))}><li class="button">Courses by Professor</li></Link>
                            </ul>
